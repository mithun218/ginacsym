 ...
 *
 *    - As these routines build on the core part of ginacsym, it is also polite to acknowledge
 *       C. Bauer, A. Frink, R. Kreckel, "Introduction to the ginacsym Framework for Symbolic Computation within the C++ Programming Language", 
