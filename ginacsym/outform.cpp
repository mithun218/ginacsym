...
namespace ginacsym{
    ...
    {
        std::string obkt = "({[", cbkt = ")}]";
        std::map<char, char> cobkt;
        ...
        for(std::string::const_iterator it = _instr.begin(); it != _instr.end(); it++)
        {
            if(obkt.find(*it) != std::string::npos)
                store.push_back(*it);
            if(cbkt.find(*it) != std::string::npos)
            {
                if(store.empty())
                    return false;
...
//    std::string to_numpy_string(const ex& expr, const std::string& prefix)
//    {
//        std::stringstream str;
//        str<<expr;
//        std::vector<std::string> functionName,functionReplaceName;
//        functionName.push_back("exp(");functionName.push_back("log(");functionName.push_back("");
//        functionName.push_back("");functionName.push_back("");functionName.push_back("");
//        functionName.push_back("");functionName.push_back("");functionName.push_back("");
//        functionName.push_back("");functionName.push_back("");functionName.push_back("");

//        functionName.push_back("sin(");functionName.push_back("cos(");functionName.push_back("tan(");
//        functionName.push_back("csc(");functionName.push_back("sec(");functionName.push_back("cot(");
//        functionName.push_back("sinh(");functionName.push_back("cosh(");functionName.push_back("tanh(");
//        functionName.push_back("csch(");functionName.push_back("sech(");functionName.push_back("coth(");
