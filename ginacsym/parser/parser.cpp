/** @file parser.cpp
 *
 *  Implementation of ginacsym's parser. */
...
// Figures out if ptr is a pointer to function or a serial of ginacsym function.
// In the former case calls that function, in the latter case constructs
// ginacsym function with corresponding serial and arguments.
...
ex parser::parse_identifier_expr()
{
	...
	// crafted serial of a ginacsym::function.
